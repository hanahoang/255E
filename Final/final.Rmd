...
boxplot(avg_conc~browse, data = df,
        ...
        xlab = "Samples",
        main = "Polyphenol Concentration Between Browsed and Non-Browsed",
...
boxplot(avg_conc~browse, data = wyoming,
        ylab = "Pholyphenol concentration (ug/uL)",
        xlab = "Samples",
        main = "Polyphenol Concentration Between Browsed and Non-Browsed in Wyoming",
        col = c("turquoise3", "turquoise4"))
boxplot(avg_conc~browse, data = threetip,
        ylab = "Pholyphenol concentration (ug/uL)",
        xlab = "Samples",
        main = "Polyphenol Concentration Between Browsed and Non-Browsed in Three-Tips",
